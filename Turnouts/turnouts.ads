...
package Turnouts is
   ...
   Time_Limit : constant Time_Span := To_Time_Span (3.0);  -- seconds

   -- Turnout status
   type Status_Rec is
      record
         Desired : Layout.Turn_Dir;  -- Requested direction
   ...
   -----------------------------------------------------------------------------
   type Recover_Ptr is access procedure (Turnout : in Layout.Turnout_Num);
   ...
   -----------------------------------------------------------------------------
   type Change_Ptr is access procedure (Turnout   : in Layout.Turnout_Num;
   ...
   -----------------------------------------------------------------------------
   function Status (Turnout : in  Layout.Turnout_Num) return Status_Rec;
   ...
   -----------------------------------------------------------------------------
   function Direction_Of (Turnout : in Layout.Turnout_Num)
