...
package body Display is
   ...
   subtype Block_Array is Layout.Display_Block_Array (1 .. Max_List);
      ...
      record
         ...
         case Which is
            ...
            when Turnout_Change =>
               ...
               Turn_Direction : Layout.Turn_Dir;
               Moving         : Boolean;
            when Error =>
   ...
   -----------------------------------------------------------------------------
   function To_String (Item : in Engineers.Skill_Rating) return String is
   -- Convert a skill level to a string with 1st character capitalized
      Result : String := Engineers.Skill_Rating'Image (Item);
   begin
         ...
         case Message.Which is
            ...
            when Train_Stop =>
               ...
               if Message.Status.Reasons (Turnout_Failure) then
                  ...
                  Count := 0;
                  for Turnout in Layout.Turnout_Num loop
   ...
   ----------------------------------------------------------------------------
   procedure Put (Turnout   : in Layout.Turnout_Num;
   ...
   ----------------------------------------------------------------------------
   procedure Put (Train : in Trains.Train_ID;
                  Skill : in Engineers.Skill_Rating) is
   ...
   ----------------------------------------------------------------------------
   procedure Put (Train  : in Trains.Train_ID;
                  Blocks : in Layout.Display_Block_Array) is
